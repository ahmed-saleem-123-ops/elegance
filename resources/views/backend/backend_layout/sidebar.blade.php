...
<div class="flex ">
    ...
    <aside class="w-64 bg-gray-900 text-gray-100 min-h-screen fixed top-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out z-10 md:relative">
        <div class="p-4 text-center font-bold text-lg border-b border-gray-700">ADMIND</div>
        <nav class="mt-4">
            <ul>
...
{{--                <li class="px-4 py-2 hover:bg-gray-800 rounded-lg mt-2"><a href="{{ route('ahmed') }}">Ahmed</a></li>--}}
            </ul>
        </nav>
    </aside>
