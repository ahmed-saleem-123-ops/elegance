...
@section('content')
<main>
        <div class="relative bg-cover bg-center" style="height: 960px;  background-image: url('/assets/images/Frame\ 97.png');" >
            <div class="relative z-10 flex flex-col items-start justify-center h-full max-w-7xl mx-auto px-14">
                <h1 class="text-4xl md:text-6xl mb-3 text-[#323232] font-times text-[56px] italic font-normal leading-normal">Pink skin formula</h1>
                <p class="mb-3 text-lg md:text-xl">True Natural - True Organic</p>
                <a href="{{ route('products') }}">
                <button class="bg-black text-white px-6 md:px-10 py-2 md:py-3 text-lg font-light">EXPLORE MORE</button>
                </a>
            </div>
        </div>
    ...
    <div class="mx-auto px-4 py-6">
        <div class="flex flex-wrap justify-between"  >
            <div class="w-full sm:w-1/2 md:w-1/4 p-2">
                <img src="/assets/images/Group 81.png" alt="Image 1" class="w-full h-auto shadow-md transform transition duration-300 ease-in-out hover:scale-105">
            </div>
            <div class="w-full sm:w-1/2 md:w-1/4 p-2">
                <img src="/assets/images/Group 82.png" alt="Image 2" class="w-full h-auto shadow-md transform transition duration-300 ease-in-out hover:scale-105">
            </div>
            <div class="w-full sm:w-1/2 md:w-1/4 p-2">
                <img src="/assets/images/Group 83.png" alt="Image 3" class="w-full h-auto shadow-md transform transition duration-300 ease-in-out hover:scale-105">
            </div>
            <div class="w-full sm:w-1/2 md:w-1/4 p-2">
                <img src="/assets/images/Group 84.png" alt="Image 4" class="w-full h-auto shadow-md transform transition duration-300 ease-in-out hover:scale-105">
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center py-28">
        ...
        <div class="flex flex-wrap justify-center gap-6 mb-2">
            @if($product1)
                <a href="{{ route('product_detail', $product1->id) }}"  class=" flex flex-col items-center group hover:scale-105 transform transition-all duration-300">
                    <img src="{{ Storage::url($product1->img) }}" alt="Image 1" class=" object-cover mb-2 group-hover:opacity-80">
                    <p class="text-center mt-2">{{ $product1->title }}</p>
                    <h1 class="text-2xl font-normal text-center mb-2">{{ $product1->category->title }}</h1>
                    <p class="text-center">{{ $product1->price }}</p>
                </a>
            @endif

            @if($product2)
                <a href="{{ route('product_detail', $product2->id) }}" class="flex flex-col items-center group hover:scale-105 transform transition-all duration-300">
                    <img src="{{ Storage::url($product2->img) }}" alt="Image 2" class=" object-cover mb-2 group-hover:opacity-80">
                    <p class="text-center mt-2">{{ $product2->title }}</p>
                    <h1 class="text-2xl font-normal text-center mb-2">{{ $product2->category->title }}</h1>
                    <p class="text-center">{{ $product2->price }}</p>
                </a>
            @endif

            @if($product3)
                <a href="{{ route('product_detail', $product3->id) }}" class="flex flex-col items-center group hover:scale-105 transform transition-all duration-300">
                    <img src="{{ Storage::url($product3->img) }}" alt="Image 3" class=" object-cover mb-2 group-hover:opacity-80">
                    <p class="text-center mt-2">{{ $product3->title }}</p>
                    <h1 class="text-2xl font-normal text-center mb-2">{{ $product3->category->title }}</h1>
                    <p class="text-center">{{ $product3->price }}</p>
                </a>
            @endif

            @if($product4)
                <a href="{{ route('product_detail', $product4->id) }}" class="flex flex-col items-center group hover:scale-105 transform transition-all duration-300">
                    <img src="{{ Storage::url($product4->img) }}" alt="Image 4" class=" object-cover mb-2 group-hover:opacity-80">
                    <p class="text-center mt-2">{{ $product4->title }}</p>
                    <h1 class="text-2xl font-normal text-center mb-2">{{ $product4->category->title }}</h1>
                    <p class="text-center">{{ $product4->price }}</p>
                </a>
            @endif
        </div>
    ...
    <div class="mx-auto ">
            ...
            <div class=" container mx-auto  ">
                <div class="flex flex-col md:flex-row gap-32  px-8 ">
                    <div class="flex flex-col justify-center">
                        ...
                        <p class="py-6 font-semibold">Embracing a new era in cosmetics</p>
                        <div class="flex  gap-4 ">
                            <div style=" border-color: #C75D68;" class="border"></div>
                    ...
                    <div>
                        <img src="/assets/images/glitz-7 1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class=" container mx-auto ">
                <div class="flex flex-col md:flex-row gap-52  px-8 py-12">
                    <div>
        ...
        <div id="secsix">
            <div class="bg-cover bg-center flex items-center justify-center px-6" 
                ...
                <div class="flex flex-col items-center">
                    ...
                    <button class="bg-black text-white px-6  py-2 md:py-3 text-lg font-semi-bold hover:bg-white hover:text-black transition-all duration-300">EXPLORE MORE</button>
                </div>
            </div>
        </div>
    ...
    <div class="pb-16">
        <div class="justify-center items-center text-center px-8 ">
            ...
            <p class="max-w-3xl mx-auto text-4xl pb-10">Our Testimonials</p>
        </div>
        <div class="bg-cover bg-center flex justify-end " style=" height: 560px; background-image: url('/assets/images/Rectangle\ 69.png');">
            <div class="flex items-center px-6 md:pr-20">
                <div class="relative py-40 bg-white shadow-lg rounded-lg p-8 max-w-lg border border-gray-300">
