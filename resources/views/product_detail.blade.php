...
{{--    </div>--}}
        ...
        <div class="flex flex-col md:flex-row justify-between items-center px-8 py-12">
            <div>
            ...
            <div class="flex flex-col justify-center p-14 shadow-xl">
                ...
                <div class="pt-6">
                    <a href="{{ route('cart.view') }}" class="uppercase bg-[#C75D68] text-white py-3 px-10 md:px-20 font-poppins">Buy now</a>
                </div>
